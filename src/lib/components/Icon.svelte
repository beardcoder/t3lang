<script lang="ts" module>
	// Minimal inline icon set (Lucide-style paths) — no external dependencies.
	export const ICONS: Record<string, string> = {
		folder:
			'M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z',
		file: 'M14 3v4a1 1 0 0 0 1 1h4M5 3h9l5 5v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z',
...
<script lang="ts">
	let { name, size = 16, stroke = 1.8 }: { name: string; size?: number; stroke?: number } =
		$props();
</script>

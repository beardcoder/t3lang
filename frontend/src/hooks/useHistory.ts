...
export function useHistory() {
  ...
  const applyChanges = useCallback((filePath: string, changes: UnitChange[], reverse: boolean) => {
  ...
  const commitChanges = useCallback((filePath: string) => {
  ...
  // Perform undo
  const performUndo = useCallback((filePath: string) => {
  ...
  // Perform redo
  const performRedo = useCallback((filePath: string) => {

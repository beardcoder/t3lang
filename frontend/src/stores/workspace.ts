...
export const useWorkspaceStore = create<WorkspaceState>()(
  immer((set, get) => ({
    ...
    setWorkspaceScan: (scan) => set((state) => {
    ...
    setActiveLanguage: (language) => set((state) => {
    ...
    cacheFileData: (path, data) => set((state) => {
    ...
    markGroupLoaded: (groupId) => set((state) => {
    ...
    updateGroupCoverage: (groupId, coverage) => set((state) => {
      const group = state.groups.get(groupId);
      if (group) {
    ...
    addFileToGroup: (groupId, language, file) => set((state) => {
      const group = state.groups.get(groupId);
      if (group) {
    ...
    removeFileFromGroup: (groupId, language) => set((state) => {
      const group = state.groups.get(groupId);
      if (group) {
    ...
    setScanning: (scanning) => set((state) => {
...
export const selectGroupsList = (state: WorkspaceState) =>
  Array.from(state.groups.values()).sort((a, b) =>

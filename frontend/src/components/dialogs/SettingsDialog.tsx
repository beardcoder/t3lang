  ...
  return (
    <DialogBase
      ...
      footer={
        <button
          onClick={closeDialog}
          className="rounded-md bg-bg-tertiary px-4 py-2 text-sm text-text-primary transition-colors hover:bg-bg-hover"
        >
          Done
        </button>
      }
    >
      <div className="space-y-6">
        ...
        {/* Indentation */}
        <div>
          <h3 className="mb-3 text-sm font-medium text-text-primary">Indentation</h3>
          <div className="flex gap-2">
            <button
